...
rule in_vivo_TI:
  ...
  output:
    spike_frequency = "output/{project}/{idx}/in-vivo/{carrier}_{beat}_{ef_strength}_{initial_weight}/spike_frequency.csv",
    voltage = "output/{project}/{idx}/in-vivo/{carrier}_{beat}_{ef_strength}_{initial_weight}/voltage.csv",
    synapse_weights = "output/{project}/{idx}/in-vivo/{carrier}_{beat}_{ef_strength}_{initial_weight}/synapse_weights.csv",
    # synapse_voltage = "output/{project}/{idx}/in-vivo/{carrier}_{beat}_{ef_strength}_{initial_weight}/synapse_voltage.csv",
    synapse_stimuli = "output/{project}/{idx}/in-vivo/{carrier}_{beat}_{ef_strength}_{initial_weight}/synapse_stimuli.csv"
  params:
    phase = 10
  conda: "neuron"
